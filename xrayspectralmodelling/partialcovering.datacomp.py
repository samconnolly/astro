...
# absorber of fixed column density and compare to real data
#===============================================================================
...
normmin = 1.E-4	# normalisation for absorbed power law
normmax = 5.E-4

#-------------------------------------------------------------------------------

nH = 0.5 	# equivalent Hydrogen column densities in 10^24 cm^-2
...
for norm in np.arange(normmin,normmax,1E-6):

	norm1 = norm
	norm2 = (normmax + normmin) - norm

	soft,hard,hardness,total = Hard(index,norm1,norm2,nH,softmin,divide,hardmax)
